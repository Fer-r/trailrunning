  ...
  return (
    <div className="relative min-h-[80vh] flex flex-col items-center justify-center">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=1470&auto=format&fit=crop')",
      ...
      <div className="relative z-10 text-center text-white px-4">
        <h1 className="text-5xl font-bold mb-6">Trail Running Hlanz</h1>
